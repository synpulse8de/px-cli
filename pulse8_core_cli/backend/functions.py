...
def backend_create(create_remote_repo: bool, answers_file: str, defaults: bool, skip_answered: bool):
    create_template(TEMPLATE_REPO_BACKEND_SPRING, create_remote_repo, answers_file, defaults, skip_answered)
