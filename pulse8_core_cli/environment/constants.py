...
SERVICES = {
    KEY_CHOICES_SERVICES_CORE_IAM: (
        "Pulse8 Core Identity & Access Management",
        "https://github.com/synpulse-group/pulse8-core-iam.git"
    ),
    KEY_CHOICES_SERVICES_CORE_NOTIFICATION_ENGINE: (
        "Pulse8 Core Notification Engine",
        "https://github.com/synpulse-group/pulse8-core-notification-engine.git"
    ),
    KEY_CHOICES_SERVICES_CORE_QUERY_ENGINE: (
        "Pulse8 Core Query Engine",
        "https://github.com/synpulse-group/pulse8-core-backend-queryengine.git"
    ),
    KEY_CHOICES_SERVICES_CORE_WORKFLOW_ENGINE: (
        "Pulse8 Core Workflow Engine",
        "https://github.com/synpulse-group/pulse8-core-workflow-engine.git"
    )
}
